...
function App() {
  ...
  */
   ...
   *   if (word === "") {
   *     /* getAllMovies(); *|
   *     //* لو الكلمة يلي المستخدم ببحث عنها فاضية، بمعنى كدا عاوز يجيب كل الأفلام ال 20 ، ف بستدعي الدالة يلي بتجيب لي كل الأفلام
   *   } else {
          ...
          <Routes>
            <Route
              ...
              element={
                <MoviesList
                // movies={movies}
                /* getPage={getPage} pageCount={pageCount} */
                />
              }
            />
            <Route
